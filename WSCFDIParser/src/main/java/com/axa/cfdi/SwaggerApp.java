package com.axa.cfdi;

import com.axa.cfdi.exception.AllExceptionMapper;
import com.axa.cfdi.rest.ParserController;
import com.axa.cfdi.rest.VersionController;
...
public class SwaggerApp extends ResourceConfig {
    ...
    public SwaggerApp(){
        register(ParserController.class);
    ...
    public void initializeSwaggerConfiguration() {
        ...
        scanner.setResourcePackage("com.axa.cfdi");
        ScannerFactory.setScanner(scanner);
        ClassReaders.setReader(new DefaultJaxrsApiReader());
        final SwaggerConfig config = ConfigFactory.config();
        config.setApiVersion("1.0");
        config.setBasePath("http://localhost:8080/WSCFDIParser/axaRest");
    }
}
